        ...
        http
                ...
                .authorizeHttpRequests(requests -> {
                        requests
                                ...
                                .requestMatchers(POST, String.format("%s/orders_details/**", apiPrefix)).hasRole(Role.USER)
                                .requestMatchers(GET, String.format("%s/orders_details/**", apiPrefix)).hasAnyRole(Role.USER , Role.ADMIN)
